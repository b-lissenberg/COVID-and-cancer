* Encoding: UTF-8.
USE ALL. 
COMPUTE filter_$=(scale=17).
FILTER BY filter_$.
EXECUTE.
CROSSTABS /TABLES=treatment_dich BY groep BY Measurement /FORMAT=AVALUE TABLES /CELLS=COUNT /COUNT ROUND CELL.
...
* single treatment: gender (p<0.001)
...
* gender te kleine sample size voor stratificatie.
