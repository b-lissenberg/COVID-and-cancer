* Encoding: UTF-8.
** multivariable voor scale=30 (continue PRO).
USE ALL. 
COMPUTE filter_$=(scale=30).
FILTER BY filter_$.
EXECUTE.
CROSSTABS /TABLES=tum_site statusM24 BY groep BY Measurement /FORMAT=AVALUE TABLES /CELLS=COUNT /COUNT ROUND CELL.
* alleen tum_site 1, 2, 4.
USE ALL. 
COMPUTE filter_$=((scale=30)&((tum_site=1)|(tum_site=2)|(tum_site=4))).
FILTER BY filter_$.
EXECUTE.
...
* no residual/recurrence/SP: tum_site (p=0.019).
